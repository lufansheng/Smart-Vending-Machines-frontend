    ...
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="vmTypeList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template #default="scope">
                    <el-button link type="primary" @click="handleUpdate(scope.row)" v-hasPermi="['manage:vmType:edit']">
                        修改
                    </el-button>
                    <el-button link type="primary" @click="handleDelete(scope.row)"
                               v-hasPermi="['manage:vmType:remove']">删除
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
            ...
            <el-form ref="vmTypeRef" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="货道数" prop="vmRow">
                    <el-input-number :min="1"
                                     :max="10" v-model="form.vmRow" placeholder="请输入货道行"/> 行 &nbsp;&nbsp;
                    <el-input-number :min="1"
                                     :max="10" v-model="form.vmCol" placeholder="请输入货道列"/> 列
                </el-form-item>
