<template>
    <div class="app-container">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template #default="scope">
                    <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                               v-hasPermi="['manage:sku:edit']">修改
                    </el-button>
                    <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                               v-hasPermi="['manage:sku:remove']">删除
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body>
            <el-form ref="skuRef" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="商品价格" prop="price">
                    <el-input-number :min="0.01" :max="999.99" step="0.5" :precision="2" v-model="form.price"
                                     placeholder="请输入商品价格"/>
                </el-form-item>
        ...
        <!--        数据导入对话框-->
        <el-dialog :title="title" v-model="excelOpen" width="500px" append-to-body>
<!--            <label>标题:</label>-->
            <el-upload
                    ref="uploadRef"
                    class="upload-demo"
...
function getSkuClassList() {
    listSkuClass(queryParams).then(response => {
