    ...
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="policyList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template #default="scope">
                    <el-button link type="primary" icon="list" @click="getPolicyInfo(scope.row)"
                               v-hasPermi="['manage:vm:list']">查看详情
                    </el-button>
                    <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                               v-hasPermi="['manage:policy:edit']">修改
                    </el-button>
                    <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                               v-hasPermi="['manage:policy:remove']">删除
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body>
            <el-form ref="policyRef" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="策略方案" prop="discount">
                    <el-input-number v-model="form.discount" min="1" max="99" precision="0"
        ...
        <el-dialog :title="title" v-model="policyOpen" width="500px" append-to-body>
            ...
            <el-table :data="vmList">
                ...
                <el-table-column label="设备编号" align="center" prop="innerCode"></el-table-column>
            </el-table>
...
import {listPolicy, getPolicy, delPolicy, addPolicy, updatePolicy} from "@/api/manage/policy.js";
