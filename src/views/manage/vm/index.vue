<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="vmList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="详细地址" align="left" prop="addr" show-overflow-tooltipt="true"/>
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                ...
                <template #default="scope">
                    <el-button link type="primary" @click="handleGoods(scope.row)" v-hasPermi="['manage:vm:edit']">
                        货道
                    </el-button>

                    <el-button link type="primary" @click="handleUpdate(scope.row)" v-hasPermi="['manage:vm:edit']">
                        修改
                    </el-button>
                    ...
                    <el-button link type="primary" @click="handleDelete(scope.row)" v-hasPermi="['manage:vm:remove']">
                        删除
                    </el-button>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body>
            <el-form ref="vmRef" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="选择点位" prop="nodeId">
                    <el-select v-model="form.nodeId" placeholder="请选择设备型号">
        ...
        <ChannelDialog :goodVisible="goodVisible" :goodData="goodData"
                       @handleCloseGood="handleCloseGood"></ChannelDialog>
...
function handleUpdatePolicy(row) {
    ...
    listPolicy(queryParams).then(response => {
