    ...
    <div class="app-container">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="300px">
                <template #default="scope">
                    <el-button link type="primary" @click="resetPwd(scope.row)"
                               v-hasPermi="['manage:partner:edit']">重置密码
                    </el-button>
                    <el-button link type="primary" @click="getPartnerInfo(scope.row)"
                               v-hasPermi="['manage:partner:query']">查看详情
                    </el-button>
                    <el-button link type="primary" @click="handleUpdate(scope.row)"
                               v-hasPermi="['manage:partner:edit']">修改
                    </el-button>
                    <el-button link type="primary" @click="handleDelete(scope.row)"
                               v-hasPermi="['manage:partner:remove']">删除
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog :title="title" v-model="partnerInfoOpen" width="500px" append-to-body>
            <el-form label-width="100px">
                <el-row :gutter="40">
                    <el-col :span="12">
                        <el-form-item label="合作商名称" :label-suffix="''">
                            {{ form.partnerName }}
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="联系人" :label-suffix="''">
                            {{ form.contactPerson }}
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="40">
                    <el-col :span="12">
                        <el-form-item label="联系电话" :label-suffix="''">
                            {{ form.contactPhone }}
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="分成比例" :label-suffix="''">
                            {{ form.profitRatio }}%
                        </el-form-item>
                    </el-col>
                </el-row>
...
function handleDelete(row) {
    ...
    proxy.$modal.confirm('是否确认删除合作商管理类编号为"' + _ids + '"的数据项？').then(function () {
